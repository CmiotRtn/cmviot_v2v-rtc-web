...
import { IAudioProcessor } from "./cmviot-rte-extension";
import { IBaseProcessor } from "./cmviot-rte-extension";
import { IExtension } from "./cmviot-rte-extension";

declare const CmviotRTC: ICmviotRTC;
export default CmviotRTC;

/**
 * @ignore
 */
declare class CmviotRTCError extends Error {
    readonly code: CmviotRTCErrorCode;
    readonly message: string;
    readonly data?: any;
    readonly name: string;
    constructor(code: CmviotRTCErrorCode, message?: string, data?: any);
    toString(): string;
    print(level?: "error" | "warning"): CmviotRTCError;
    throw(): never;
}
 ...
 * @ignore
 */
declare enum CmviotRTCErrorCode {
...
/**
 * Statistics of the call, which can be retrieved by calling [CmviotRTCClient.getRTCStats]{@link ICmviotRTCClient.getRTCStats}.
 */
export declare interface CmviotRTCStats {
    /**
    ...
    UserCount: number;
    /**
     * RTT (Round-Trip Time) between the SDK and Cmviot's edge server, in ms.
     */
    RTT: number;
    /**
...
/**
 * Regions for the connection. Used for calling [CmviotRTC.setArea]{@link ICmviotRTC.setArea}.
 */
 ...
 *
 * You can customize the audio encoder configurations when calling [CmviotRTC.createCustomAudioTrack]{@link ICmviotRTC.createCustomAudioTrack}, [CmviotRTC.createMicrophoneAudioTrack]{@link ICmviotRTC.createMicrophoneAudioTrack} or [CmviotRTC.createBufferSourceAudioTrack]{@link ICmviotRTC.createBufferSourceAudioTrack}.
 */
 ...
 * - [CmviotRTC.createCustomAudioTrack]{@link ICmviotRTC.createCustomAudioTrack}
 * - [CmviotRTC.createMicrophoneAudioTrack]{@link ICmviotRTC.createMicrophoneAudioTrack}
 * - [CmviotRTC.createBufferSourceAudioTrack]{@link ICmviotRTC.createBufferSourceAudioTrack}
 *
...
/**
 * Configurations for the audio track from an audio file or `AudioBuffer` object. Set these configurations when calling [CmviotRTC.createBufferSourceAudioTrack]{@link ICmviotRTC.createBufferSourceAudioTrack}.
 */
...
/**
 * Configurations for the video track from the video captured by a camera. Set these configurations when calling [CmviotRTC.createCameraVideoTrack]{@link ICmviotRTC.createCameraVideoTrack}.
 */
export declare interface CameraVideoTrackInitConfig {
     ...
     *
     * You can get a list of the available cameras by calling [CmviotRTC.getCameras]{@link ICmviotRTC.getCameras}.
     */
    cameraId?: string;
    /**
     * **Since**
...
/**
 * The error code of the media stream relay. You can get the code through [CmviotRTCClient.on("channel-media-relay-state")]{@link ICmviotRTCClient.event_channel_media_relay_state}.
 */
...
/**
 * Events during the media stream relay. You can get the event through [CmviotRTCClient.on("channel-media-relay-event")]{@link ICmviotRTCClient.event_channel_media_relay_event}.
 */
...
/**
 * The state code of the media stream relay. You can get the code through [CmviotRTCClient.on("channel-media-relay-state")]{@link ICmviotRTCClient.event_channel_media_relay_state}.
 */
...
export declare interface ClientConfig {
     ...
     * - `"live"`: Sets the channel profile as live streaming. You need to go on to call [setClientRole]{@link ICmviotRTCClient.setClientRole} to set the client as either a host or an audience. A host can send and receive audio or video, while an audience can only receive audio or video.
 ...
 *
 * Used by the {@link ClientConfig.clientRoleOptions} property or the [CmviotRTCClient.setClientRole]{@link ICmviotRTCClient.setClientRole} method.
 */
...
/**
 * Connection state between the SDK and Cmviot's edge server.
 *
 * You can get the connection state through [connectionState]{@link ICmviotRTCClient.connectionState}.
 *
 ...
 *  - This is the initial state until you call [join]{@link ICmviotRTCClient.join}.
 *  - The SDK also enters this state after you call [leave]{@link ICmviotRTCClient.leave}, when the user is banned, or when the connection fails.
 * - `"CONNECTING"`: The SDK is connecting to the server. The SDK enters this state when you call [join]{@link ICmviotRTCClient.join}.
 ...
 * - `"DISCONNECTING"`: The SDK is disconnecting from the server. The SDK enters this state when you call [leave]{@link ICmviotRTCClient.leave}.
 */
...
/**
 * Configurations for the custom audio track. Set these configurations when calling [CmviotRTC.createCustomAudioTrack]{@link ICmviotRTC.createCustomAudioTrack}.
 */
...
/**
 * Configurations for the custom video track. Set these configurations when calling [CmviotRTC.createCustomVideoTrack]{@link ICmviotRTC.createCustomVideoTrack}.
 */
...
declare function event_content_inspect_error(error?: CmviotRTCError): void;
 ...
 *
 * The SDK triggers this callback to indicate whether the media stream is forwarded by the Cmviot cloud proxy service.
 ...
 *
 * @param isUsingProxy Whether the media stream is forwarded by the Cmviot cloud proxy service.
 * - `true`: Forwarded by the Cmviot cloud proxy service.
 * - `false`: Not forwarded by the Cmviot cloud proxy service.
 * @asMemberOf ICmviotRTCClient
 * @event
 */
 ...
 *
 * As of v4.11.0, if the SDK fails in the attempt to directly connect to Cmviot SD-RTN™ after you call [[join]],
 ...
 * - `LIVE_STREAMING_INTERNAL_SERVER_ERROR`: An error occurs in Cmviot's streaming server.
 ...
 * @event
 */
declare function event_live_streaming_error(url: string, err: CmviotRTCError): void;
 ...
 * @event
 */
declare function event_live_streaming_warning(url: string, warning: CmviotRTCError): void;
 ...
 *
 * > Cmviot recommends listening for this event and displaying the network quality.
 *
 ...
 * > - `published-user-list` has the following impacts on [CmviotRTCClient.on("user-joined")]{@link event_user_joined} and [CmviotRTCClient.on("user-published")]{@link event_user_published}:
 ...
 * @event
 */
declare function event_published_user_list(users: ICmviotRTCRemoteUser): void;
 ...
 *
 * In most cases, you only need to listen for [user-published]{@link ICmviotRTCClient.event_user_published} and [user-unpublished]{@link ICmviotRTCClient.event_user_unpublished} events for operations including subscribing, unsubscribing, and displaying whether the remote user turns on the camera and microphone. You do not need to pay special attention to user states since the SDK automatically handles user states.
 *
 * > This event indicating the media stream of a remote user is active does not necessarily mean that the local user can subscribe to this remote user. The local user can subscribe to a remote user only when receiving the [user-published]{@link ICmviotRTCClient.event_user_published} event.
 *
 * @param uid The ID of the remote user.
 ...
 * @event
 */
declare function event_user_joined(user: ICmviotRTCRemoteUser): void;
 ...
 * @event
 */
declare function event_user_left(user: ICmviotRTCRemoteUser, reason: string): void;
 ...
 * @event
 */
declare function event_user_published(user: ICmviotRTCRemoteUser, mediaType: "audio" | "video"): void;
 ...
 * @event
 */
declare function event_user_unpublished(user: ICmviotRTCRemoteUser, mediaType: "audio" | "video"): void;
...
/**
 * Parameters for reporting customized messages. Used when calling [CmviotRTCClient.sendCustomReportMessage]{@link ICmviotRTCClient.sendCustomReportMessage}.
 */
...
/**
 * The entry point of the Cmviot Web SDK.
 */
export declare interface ICmviotRTC {
    /**
     * The version of the Cmviot Web SDK.
     */
    VERSION: string;
    /**
     * Gets the codecs that the browser supports.
     *
     * This method gets a list of the codecs supported by the SDK and the web browser. The Cmviot Web SDK supports video codecs VP8 and H.264, and audio codec OPUS.
     *
     * > Note:
     ...
     *
     * ```javascript
     * CmviotRTC.getSupportedCodec().then(result => {
     ...
     *
     * This is usually the first step of using the Cmviot Web SDK.
     ...
     * @category Cmviot Core
     */
    createClient(config: ClientConfig): ICmviotRTCClient;
    /**
     ...
     * > - The [MediaDeviceInfo.deviceId](https://developer.mozilla.org/en-US/docs/Web/API/MediaDeviceInfo/deviceId) property of a device may change. For example, it is reset when the user clears cookies. Cmviot does not recommend using the `deviceId` property to implement your business logic.
     *
     * ```javascript
     ...
     *   const screenVideoTrack = await CmviotRTC.createScreenVideoTrack({ electronScreenSourceId: source.id });
     * })()
     *
     * ```
     ...
     *
     * For example, if you set the log level as `CmviotRTC.setLogLevel(1);`, then you can see logs in levels INFO, ERROR, and WARNING.
     ...
     * Enables log upload.
     *
     * Call this method to enable log upload to Cmviot’s server.
     *
     ...
     *
     * > If a user fails to join the channel, the log information (for that user) is unavailable on Cmviot's server.
     * @category Logger
     */
     ...
     *
     * Cmviot recommends calling this method before starting a call to check the availability of the video capture device. You can pass the camera video track as a parameter in this method to check whether the camera works.
     *
     * > Notes:
     ...
     *
     * ``` javascript
     * const videoTrack = await CmviotRTC.createCameraVideoTrack({ cameraId });
     * CmviotRTC.checkVideoTrackIsActive(videoTrack).then(result => {
     ...
     *
     * Cmviot recommends calling this method before starting a call to check the availability of the audio sampling device. You can pass the audio track from the audio sampled by a microphone as a parameter in this method to check whether the microphone works.
     *
     * > Notes:
     * > - The check may fail in a quiet environment. Cmviot suggests you instruct the end user to speak or make some noise when calling this method.
     * > - If an audio track is muted, this method returns `false`.
     * > - Do not call this method frequently as the check may affect web performance.
     *
     * ``` javascript
     * const audioTrack = await CmviotRTC.createMicrophoneAudioTrack({ microphoneId });
     * CmviotRTC.checkAudioTrackIsActive(audioTrack).then(result => {
     ...
     *
     * ``` javascript
     * CmviotRTC.onCameraChanged = (info) => {
     ...
     *
     * ``` javascript
     * CmviotRTC.onMicrophoneChanged = (info) => {
     ...
     *
     * ``` javascript
     * CmviotRTC.onPlaybackDeviceChanged = (info) => {
     ...
     *
     * In the Cmviot Web SDK, once the user has interacted with the webpage, the autoplay blocking is removed. You can deal with the issue in either of the following ways:
     ...
     *  CmviotRTC.onAudioAutoplayFailed = () => {
     ...
     *
     * Occurs when Cmviot-related services cause CSP (Content Security Policy) violations.
     *
     * When Cmviot fails to load a resource or send a request due to CSP violations, the SDK triggers this callback.
     * After receiving this callback, modify your CSP configuration to ensure that you can access Cmviot-related services.
     */
     ...
     *
     * By default, the SDK connects to nearby Cmviot servers. After specifying the region, the SDK connects to the Cmviot servers within that region.
     *
     * ```javascript
     ...
     *   CmviotRTC.processExternalMediaAEC(element);
     * </script>
     * ```
     *
     ...
     *
     * Cmviot supports the following extensions:
     * - [Virtual Background Extension](https://docs.cmviot.io/en/Video/virtual_background_web_ng?platform=Web)
     * - [AI Denoiser Extension](https://docs.cmviot.io/en/Video/noise_reduction_web_ng?platform=Web)
     * - [Image Enhancement Extension](https://docs.cmviot.io/cn/Video/beauty_effect_web_ng?platform=Web)
     *
 ...
 *
 * An `CmviotRTCClient` object is created by the [[createClient]] method.
 * @public
 */
export declare interface ICmviotRTCClient extends EventEmitter {
    /**
     * Connection state between the SDK and the Cmviot server.
     */
     ...
     */
    readonly remoteUsers: ICmviotRTCRemoteUser[];
    /**
     * **Since**
     * <br>&emsp;&emsp;&emsp;*4.0.0*
     *
     ...
     *
     * When joining a channel, the [CmviotRTCClient.on("connection-state-change")]{@link event_connection_state_change} callback is triggered on the local client.
     *
     * After joining a channel, if the user is in the communication profile, or is a host in the Live Broadcast profile, the [CmviotRTCClient.on("user-joined")]{@link event_user_joined} callback is triggered on the remote client.
     *
     * @param appid The [App ID](https://docs.cmviot.io/en/Cmviot%20Platform/terms?platform=All%20Platforms#appid) of your Cmviot project.
     * @param token The token generated at your server:
     * - For low-security requirements: You can use the temporary token generated at Console. For details, see [Get an RTC temporary token](https://docs.cmviot.io/en/Cmviot%20Platform/get_appid_token?platform=All%20Platforms#generate-an-rtc-temporary-token).
     * - For high-security requirements: Set it as the token generated at your server. For details, see [Authenticate Your Users with Tokens](https://docs.cmviot.io/en/Video/token_server?platform=Web).
     ...
     * @param uid The user ID, an integer or a string, ASCII characters only. Ensure this ID is unique. If you set the `uid` to `null`, the Cmviot server assigns a number uid and returns it in the Promise object.
     ...
     *
     * <div class="alert warning">To ensure a better end-user experience, Cmviot recommends using a number as the user ID.</div>
     *
     * > Note:
     * > - All users in the same channel should have the same type (number or string) of `uid`.
     * > - You can use string UIDs to interoperate with the Native SDK 2.8 or later. Ensure that the Native SDK uses the User Account to join the channel. See [Use String User Accounts](https://docs.cmviot.io/en/faq/string).
     * > - To ensure the data accuracy in Cmviot Analytics, Cmviot recommends that you specify `uid` for each user and ensure it is unique.
     *
     ...
     * - If you leave the `uid` parameter empty or set it as `null`, the Cmviot server assigns a number `uid` and returns it.
     * @category Cmviot Core
     */
     ...
     * Leaves a channel.
     *
     * When leaving the channel, the [CmviotRTCClient.on("connection-state-change")]{@link ICmviotRTCClient.event_connection_state_change} callback is triggered on the local client.
     *
     * When a user (in the communication profile) or a host (in the live-broadcast profile) leaves the channel, the [CmviotRTCClient.on("user-left")]{@link ICmviotRTCClient.event_user_left} callback is triggered on each remote client in the channel.
     * @category Cmviot Core
     */
    leave(): Promise<void>;
    /**
     ...
     *
     * After publishing the local tracks, the [CmviotRTCClient.on("user-published")]{@link event_user_published} callback is triggered on the remote client.
     *
     * > Note:
     ...
     * > - An `CmviotRTCClient` object can publish multiple audio tracks. The SDK automatically mixes the audio tracks into one audio track. Exception: Safari does not support publishing multiple audio tracks on versions earlier than Safari 12.
     * > - An `CmviotRTCClient` object can publish **only one video track**. If you want to switch the published video track, for example, from a camera video track to a scree-sharing video track, you must unpublish the published video track.
     * @param tracks Local tracks created by [CmviotRTC.createMicrophoneAudioTrack]{@link ICmviotRTC.createMicrophoneAudioTrack} / [CmviotRTC.createCameraVideoTrack]{@link ICmviotRTC.createCameraVideoTrack} or other methods.
     * @category Cmviot Core
     */
     ...
     *
     * After the local client unpublishes, the [CmviotRTCClient.on("user-unpublished")]{@link event_user_unpublished} callback is triggered on each remote client in the channel.
     *
     ...
     *
     * @returns When the subscription succeeds, the SDK adds the subscribed tracks to [user.audioTrack]{@link ICmviotRTCRemoteUser.audioTrack} and [user.videoTrack]{@link ICmviotRTCRemoteUser.videoTrack}. You can go on to call [audioTrack.play]{@link IRemoteAudioTrack.play} or [videoTrack.play]{@link IRemoteVideoTrack.play} to play the tracks.
     * > The `Promise` object throws the `TRACK_IS_NOT_PUBLISHED` error if the specified tracks do not exist.
     * @category Cmviot Core
     */
    subscribe(user: ICmviotRTCRemoteUser, mediaType: "video"): Promise<IRemoteVideoTrack>;
    /**
     * Subscribes to the audio and/or video tracks of a remote user.
     *
     * ```javascript
     ...
     * @category Cmviot Core
     */
    subscribe(user: ICmviotRTCRemoteUser, mediaType: "audio"): Promise<IRemoteAudioTrack>;
    /**
     * Subscribes to the audio and/or video tracks of a remote user.
     *
     * ```javascript
     ...
     * @category Cmviot Core
     */
    subscribe(user: ICmviotRTCRemoteUser, mediaType: "video" | "audio"): Promise<IRemoteTrack>;
    /**
     * **Since**
     * <br>&emsp;&emsp;&emsp;*4.11.0*
     *
     ...
     * - `user`: The remote user. See [CmviotRTCRemoteUser]{@link ICmviotRTCRemoteUser}.
    ...
    massSubscribe(subscribeList: {
        user: ICmviotRTCRemoteUser;
        mediaType: "audio" | "video";
    }[]): Promise<{
        user: ICmviotRTCRemoteUser;
        mediaType: "audio" | "video";
        track?: IRemoteTrack;
        error?: CmviotRTCError;
    }[]>;
    /**
     ...
     * @category Cmviot Core
     */
    unsubscribe(user: ICmviotRTCRemoteUser, mediaType?: "video" | "audio"): Promise<void>;
    /**
     * **Since**
     * <br>&emsp;&emsp;&emsp;*4.11.0*
     *
     ...
     * > - If the local client switches the user role after joining a channel, the SDK triggers the [CmviotRTCClient.on("user-joined")]{@link event_user_joined} or [CmviotRTCClient.on("user-left")]{@link event_user_left} callback on the remote client.
     ...
     *
     * You can also use cloud proxy by {@link startProxyServer}. See [Use Cloud Proxy](https://docs.cmviot.io/en/Interactive%20Broadcast/cloud_proxy_web?platform=Web) for details.
     *
     * > Note:
     * > - Call this method before {@link join}.
     * > - Proxy services by different service providers may result in slow performance if you are using the Firefox browser. Therefore, Cmviot recommends using the same service provider for the proxy services. If you use different service providers, Cmviot recommends not using the Firefox browser.
     ...
     *
     * For the extra settings required for using the cloud proxy service, see [Use Cloud Proxy](https://docs.cmviot.io/en/Interactive%20Broadcast/cloud_proxy_web_ng?platform=Web).
     *
     ...
     *
     * > - Cmviot suggests calling `setRemoteDefaultVideoStreamType` before joining the channel.
     ...
     *
     * If the auto-fallback option is enabled, the SDK triggers the [CmviotRTCClient.on("stream-type-changed")]{@link event_stream_type_changed} callback when the remote stream changes from a high-quality video stream to a low-quality video stream or vice versa, and triggers the [CmviotRTCClient.on("stream-fallback")]{@link event_stream_fallback} callback when the remote stream changes from a video stream to an audio stream or vice versa.
     *
     ...
     *
     * If the encryption configurations are incorrect, the SDK triggers the [CmviotRTCClient.on("crypt-error")]{@link event_crypt_error} callback when publishing tracks or subscribing to tracks.
     *
     * > Notes:
     ...
     * @param secret The encryption secret. ASCII characters only. When a user uses a weak secret, the SDK outputs a warning message to the Web Console and prompts the users to set a strong secret. A strong secret must contain at least eight characters and be a combination of uppercase and lowercase letters, numbers, and special characters. Due to browser encryption algorithm limitations, the secret length cannot exceed 62 characters. Cmviot recommends you use OpenSSL to generate the secret on your server. For details, see [Media Stream Encryption](https://docs.cmviot.io/en/Video/channel_encryption_web_ng?platform=Web).
     * @param salt The salt. Only valid when you set the encryption mode as `"aes-128-gcm2"` or `"aes-256-gcm2"`. Cmviot recommends you use OpenSSL to generate the salt on your server. For details, see [Media Stream Encryption](https://docs.cmviot.io/en/Video/channel_encryption_web_ng?platform=Web).
     */
    setEncryptionConfig(encryptionMode: EncryptionMode, secret: string, salt?: Uint8Array): void;
    /**
     * Renews the token.
     *
     * The token expires after a set time once token is enabled. When the SDK triggers the [CmviotRTCClient.on("token-privilege-will-expire")]{@link event_token_privilege_will_expire} callback, call this method to pass a new token. Otherwise the SDK disconnects from the server.
     ...
     *
     * After the volume indicator is enabled, the SDK triggers the [CmviotRTCClient.on("volume-indicator")]{@link event_volume_indicator} callback to report the volumes every two seconds, regardless of whether there are active speakers in the channel.
     *
     ...
     */
    getRTCStats(): CmviotRTCStats;
    /**
     * Sets the video layout and audio for CDN live streaming.
     *
     * > Ensure that you [enable the RTMP Converter service](https://docs.cmviot.io/en/Interactive%20Broadcast/cdn_streaming_web?platform=Web#prerequisites) before using this function.
     ...
     *
     * See [Push Streams to the CDN](https://docs.cmviot.io/en/Interactive%20Broadcast/cdn_streaming_web?platform=Web) for details.
     *
     * > Note:
     ...
     * @ignore
     *
     * > Note: Cmviot will soon stop the service for injecting online media streams on the client. If you have not implemented this service, Cmviot recommends that you do not use it.
     *
     * Injects an online media stream to a live-broadcast channel.
     *
     * After you call this method, the server pulls the online stream and injects it into a live-broadcast channel. This is applicable to scenarios where all audience members in the channel can watch a live show and interact with each other. See [Inject Online Media Stream](https://docs.cmviot.io/en/Interactive%20Broadcast/inject_stream_web_ng?platform=Web) for details.
     *
     * If the online media stream is injected successfully, this stream is added to the channel, and all users in the channel receive the [CmviotRTCClient.on("user-published")]{@link event_user_published} and [CmviotRTCClient.on("user-joined")]{@link event_user_joined} callbacks with the `uid` 666.
     *
     * The SDK reports the status of the media stream by triggering the [CmviotRTCClient.on("stream-inject-status")]{@link event_stream_inject_status} event.
     *
     ...
     *
     * If the injected stream is removed successfully, all users in the channel receive the [CmviotRTCClient.on("user-left")]{@link event_user_left} and [CmviotRTCClient.on("user-unpublished")]{@link event_user_unpublished} callbacks.
     * @category Inject Stream
     */
     ...
     *
     * - [CmviotRTCClient.on("channel-media-relay-state")]{@link event_channel_media_relay_state}, which reports the state and error code of the media stream relay.
     ...
     * - [CmviotRTCClient.on("channel-media-relay-event")]{@link event_channel_media_relay_event}, which reports the events of the media stream relay.
     ...
     * > Note:
     * >
     * > - Contact sales-us@cmviot.io to enable this function.
    ...
    /**
     * Reports customized messages to Cmviot's data center.
     *
     * > Temporarily, Cmviot supports reporting a maximum of 20 message pieces within 5 seconds.
     *
...
/**
 * Information about a remote user. You can get this through [CmviotRTCClient.remoteUsers]{@link ICmviotRTCClient.remoteUsers}.
 */
export declare interface ICmviotRTCRemoteUser {
    /**
 ...
 *
 * You can create an audio track from an audio file by calling [CmviotRTC.createBufferSourceAudioTrack]{@link ICmviotRTC.createBufferSourceAudioTrack}.
 */
 ...
 *
 * You can create a local camera video track by calling [CmviotRTC.createCameraVideoTrack]{@link ICmviotRTC.createCameraVideoTrack}.
 */
export declare interface ICameraVideoTrack extends ILocalVideoTrack {
     ...
     *
     * @param deviceId The ID of the specified device. You can get the `deviceId` by calling [CmviotRTC.getCameras]{@link ICmviotRTC.getCameras}.
     */
     ...
     * > - If a track is published, disabling this track triggers the [user-unpublished]{@link ICmviotRTCClient.event_user_unpublished} event on the remote client, and re-enabling this track triggers the [user-published]{@link ICmviotRTCClient.event_user_published} event.
 ...
 *
 * Use this interface to set the media stream relay when calling [startChannelMediaRelay]{@link ICmviotRTCClient.startChannelMediaRelay} or [updateChannelMediaRelay]{@link ICmviotRTCClient.updateChannelMediaRelay}.
 *
 * ```javascript
 * const configuration = CmviotRTC.createChannelMediaRelayConfiguration();
 ...
 *
 * You can create a local audio track by calling [CmviotRTC.createCustomAudioTrack]{@link ICmviotRTC.createCustomAudioTrack}.
 *
...
export declare interface ILocalAudioTrack extends ILocalTrack {
     ...
     * Gets the statistics of a local audio track.
     *
     * **DEPRECATED** from v4.1.0. Use [CmviotRTCClient.getLocalVideoStats]{@link ICmviotRTCClient.getLocalVideoStats} and [CmviotRTCClient.getLocalAudioStats]{@link ICmviotRTCClient.getLocalAudioStats} instead.
     */
...
export declare interface ILocalTrack extends ITrack {
     ...
     * <br>&emsp;&emsp;&emsp;*4.6.0*
     *
     * If the track is published, a successful call of `setMuted(true)` triggers the [user-unpublished]{@link ICmviotRTCClient.event_user_unpublished} event on the remote client, and a successful call of `setMuted(false)` triggers the [user-published]{@link ICmviotRTCClient.event_user_published} event.
     *
     * > - Calling `setMuted(true)` does not stop capturing audio or video and takes shorter time to take effect than [[setEnabled]]. For details, see [What are the differences between setEnabled and setMuted?](https://docs.cmviot.io/en/Interactive%20Broadcast/faq/differences_between_setenabled_and_setmuted).
     * > - Do not call `setEnabled` and `setMuted` together.
     *
 ...
 *
 * You can get create a local video track by calling [CmviotRTC.createCustomVideoTrack]{@link ICmviotRTC.createCustomVideoTrack} or [CmviotRTC.createScreenVideoTrack]{@link ICmviotRTC.createScreenVideoTrack} method.
 *
...
export declare interface ILocalVideoTrack extends ILocalTrack {
     ...
     *
     * > Notes:
     * > - Cmviot is planning to sunset this built-in image enhancement feature.
     * You can use the upgraded Image Enhancement Extension instead. For details, see
     * [Use the Image Enhancement Extension](https://docs.cmviot.io/en/Video/beauty_effect_web_ng?platform=Web).
 ...
 *
 * You can create a local microphone audio track by calling [CmviotRTC.createMicrophoneAudioTrack]{@link ICmviotRTC.createMicrophoneAudioTrack}.
 */
export declare interface IMicrophoneAudioTrack extends ILocalAudioTrack {
     ...
     *
     * @param deviceId The ID of the specified device. You can get the `deviceId` by calling [CmviotRTC.getMicrophones]{@link ICmviotRTC.getMicrophones}.
     */
    setDevice(deviceId: string): Promise<void>;
    /**
     * **Since**
...
/**
 * @ignore
 * The configurations for the injected online stream in [CmviotRTCClient.addInjectStreamUrl]{@link ICmviotRTCClient.addInjectStreamUrl}.
 */
export declare interface InjectStreamConfig {
     ...
     * - 48000: 48 kHz
     *
     * > Cmviot recommends using the default value.
     */
 ...
 *
 * You can get create a remote audio track by the [CmviotRTCRemoteUser.audioTrack]{@link ICmviotRTCRemoteUser.audioTrack} object after calling [subscribe]{@link ICmviotRTCClient.subscribe}.
 */
...
export declare interface IRemoteTrack extends ITrack {
     ...
     *
     * **DEPRECATED** from v4.1.0. Use [CmviotRTCClient.getRemoteVideoStats]{@link ICmviotRTCClient.getRemoteVideoStats} and [CmviotRTCClient.getRemoteAudioStats]{@link ICmviotRTCClient.getRemoteAudioStats} instead.
 ...
 *
 * You can get create a remote video track by the [CmviotRTCRemoteUser.videoTrack]{@link ICmviotRTCRemoteUser.videoTrack} object after calling [subscribe]{@link ICmviotRTCClient.subscribe}.
 */
...
/**
 * The configurations for CDN live stream transcoding. To be used when you call [setLiveTranscoding]{@link ICmviotRTCClient.setLiveTranscoding}.
 */
export declare interface LiveStreamingTranscodingConfig {
     ...
     *
     * Cmviot recommends choosing 1 (mono), or 2 (stereo) audio channels. Special players are required if you choose 3, 4, or 5.
     *
     * - 1: (Default) Mono
     * - 2: Stereo
     ...
     *
     * - When pushing video streams to the CDN, ensure that `height` is at least 64; otherwise, the Cmviot server adjusts the value to 64.
     ...
     *
     * - When pushing video streams to the CDN, ensure that `width` is at least 64; otherwise, the Cmviot server adjusts the value to 64.
     * - When pushing audio streams to the CDN, set `width` and `height` as 0.
     */
    width?: number;
    /**
     ...
     *
     * Set it as `66`, `77`, or `100` (default). If you set this parameter to any other value, the Cmviot server adjusts it to the default value `100`.
     *
     ...
     *
     * The default value is 15. The Cmviot server adjusts any value over 30 to 30.
     */
    videoFrameRate?: number;
    /**
     ...
     *
     * Cmviot supports a maximum of 17 transcoding users in a CDN streaming channel.
     */
...
/**
 * Information of the local audio track, which can be retrieved by calling [CmviotRTCClient.getLocalAudioStats]{@link ICmviotRTCClient.getLocalAudioStats}.
 */
...
/**
 * Information of the local video track, which can be retrieved by calling [CmviotRTCClient.getLocalVideoStats]{@link ICmviotRTCClient.getLocalVideoStats}.
 */
...
/**
 * The video profile of the low-quality video stream. Set the the video profile of the low-quality video stream when calling [setLowStreamParameter]{@link ICmviotRTCClient.setLowStreamParameter}.
 */
...
/**
 * Configurations for the audio track from the audio captured by a microphone. Set these configurations when calling [CmviotRTC.createMicrophoneAudioTrack]{@link ICmviotRTC.createMicrophoneAudioTrack}.
 */
export declare interface MicrophoneAudioTrackInitConfig {
     ...
     *
     * You can get a list of the available microphones by calling [CmviotRTC.getMicrophones]{@link ICmviotRTC.getMicrophones}.
     */
    microphoneId?: string;
    /**
     * @ignore
 ...
 *
 * Last mile refers to the connection between the local device and Cmviot edge server.
 *
 * - After the local user joins the channel, the SDK triggers the [CmviotRTCClient.on("network-quality")]{@link ICmviotRTCClient.event_network_quality} callback once every two seconds and provides the uplink and downlink last-mile network conditions of the user through this interface.
 * - You can call [CmviotRTCClient.getRemoteNetworkQuality]{@link ICmviotRTCClient.getRemoteNetworkQuality} to get the network quality of all remote users to whom the local user subscribes.
 *
...
/**
 * Statistics of the remote audio track, such as connection and transmission statistics, which can be retrieved by calling [CmviotRTCClient.getRemoteAudioStats]{@link ICmviotRTCClient.getRemoteAudioStats}.
 */
...
/**
 * The stream fallback option. Set the stream fallback option when calling [setStreamFallbackOption]{@link ICmviotRTCClient.setStreamFallbackOption}.
 *
 */
...
/**
 * The video type of the remote stream. Set the video type of the remote stream when calling [setRemoteVideoStreamType]{@link ICmviotRTCClient.setRemoteVideoStreamType}.
 */
...
/**
 * Statistics of the remote video track, such as connection and transmission statistics, which can be retrieved by calling [CmviotRTCClient.getRemoteVideoStats]{@link ICmviotRTCClient.getRemoteVideoStats}.
 */
 ...
 *
 * You can pass the preset video encoder configurations when calling [CmviotRTC.createScreenVideoTrack]{@link ICmviotRTC.createScreenVideoTrack}.
 *
...
/**
 * Configurations for the video track for screen sharing. Set these configurations when calling [CmviotRTC.createScreenVideoTrack]{@link ICmviotRTC.createScreenVideoTrack}.
 */
 ...
 *
 * The SDK supports the following channel profiles:
 * - `"live"`: Sets the channel profile as live broadcast. You need to go on to call [setClientRole]{@link ICmviotRTCClient.setClientRole} to set the client as either a host or an audience. A host can send and receive audio or video, while an audience can only receive audio or video.
 * - `"rtc"`: Sets the channel profile as communication. It is used for a one-on-one call or a group call where all users in the channel can converse freely.
 */
...
/**
 * @ignore
 * The configuration of your TURN server. Used when calling [setTurnServer]{@link ICmviotRTCClient.setTurnServer}.
 */
 ...
 *
 * To ensure a better end-user experience, Cmviot recommends using a number as the user ID. See {@link join} for details.
 */
 ...
 *
 * You can customize the video encoder configurations when calling [CmviotRTC.createCameraVideoTrack]{@link ICmviotRTC.createCameraVideoTrack} or [CmviotRTC.createScreenVideoTrack]{@link ICmviotRTC.createScreenVideoTrack}.
 *
 * The SDK provides the preset video encoder configurations. For more information, see [[VideoEncoderConfigurationPreset]].
 *
 * > The actual bitrate may differ slightly from the value you set due to the limitations of the operation system or the web browser. Cmviot recommends setting the bitrate between 100 Kbps and 5000 Kbps.
 */
 ...
 *
 * You can pass the preset video encoder configurations when calling [CmviotRTC.createCameraVideoTrack]{@link ICmviotRTC.createCameraVideoTrack} or [CmviotRTC.createScreenVideoTrack]{@link ICmviotRTC.createScreenVideoTrack}.
 *
