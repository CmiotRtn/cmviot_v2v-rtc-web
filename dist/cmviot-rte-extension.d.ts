declare interface CmviotApiExecutor<T> {
...
export declare interface IExtensionReporter {
    reportApiInvoke<T>(params: ReportApiInvokeParams, throttleTime?: number): CmviotApiExecutor<T>;
}
...
declare class Reporter implements IExtensionReporter {
    ...
    reportApiInvoke<T>(params: ReportApiInvokeParams): CmviotApiExecutor<T>;
